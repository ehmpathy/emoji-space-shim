import type { TerminalChoice } from '@src/domain.objects/TerminalChoice';
import { detectTerminalChoice } from '@src/domain.operations/detectTerminalChoice';
import { transformConsoleArgs } from '@src/domain.operations/transformConsoleArgs';
